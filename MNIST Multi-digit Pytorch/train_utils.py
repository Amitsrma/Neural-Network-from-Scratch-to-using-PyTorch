...
def train_model(train_data, dev_data, model, lr=0.01, momentum=0.9, nesterov=False, n_epochs=5):
...
#        if count < 20:
#            count+=1
#            print("predicted first label:",predictions_first_label,"\npredicted second label:",predictions_second_label)
#            print("\nactual label 1st:",y[0],"\nactual label 2nd:",y[1])
#        else:
#            return None
